...
This project is licensed under the GNU GPLv3 License - see the [LICENSE](LICENSE) file for details. GridLLM reserves the right to change license and distribution at any time and without notice.